    ...
    <div id="box">
        ...
        <section id="section2">
            <table width="80%" align="center">
                ...
                <tr>
                    <td>
                        <a href="music.jsp"><span class="text">Music</span></a>
                    </td>
                    <td>
                        <a href="lyrics.jsp"><span class="text">Lyrics</span></a>
                    </td>
                    <td>
                        <a href="collaboration.jsp"><span class="text">Collaboration</span></a>
                    </td>
                </tr>
            </table>
        </section>
