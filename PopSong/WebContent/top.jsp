...
<header>
        <ul>
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-content">
                    <a class="menubar" href="bbs.jsp">R&B/Hip-Hop</a>
                    <a class="menubar" href="bbs.jsp">Dance</a>
                    <a class="menubar" href="bbs.jsp">Pop</a>
                    <a class="menubar" href="bbs.jsp">Rap</a>
                    <a class="menubar" href="bbs.jsp">Rock</a>
                    <a class="menubar" href="bbs.jsp">Jazz-Pop</a>
                </div>
            </li>
            <li class="dropdown">
