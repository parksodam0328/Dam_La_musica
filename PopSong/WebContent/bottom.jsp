...
<footer>
            <nav>
                ...
                <div class="footer_nav">
                    ...
                    <ul class="footer_content">
                        <li>
                            <a href="bbs.jsp">R&B/Hip-Hop</a>
                        </li>
                        <li>
                            <a href="bbs.jsp">Dance</a>
                        </li>
                        <li>
                            <a href="bbs.jsp">Pop</a>
                        </li>
                        <li>
                            <a href="bbs.jsp">Rap</a>
                        </li>
                    </ul>
                    <ul>
                        <li>
                            <a href="bbs.jsp">Rock</a>
                        </li>
                        <li>
                            <a href="bbs.jsp">Jazz-Pop</a>
                        </li>
                    </ul>
                </div>
                <div class="footer_nav">
                    ...
                    <ul class="footer_content">
                        <li>
                            <a href="video.jsp">Music Video</a>
                        </li>
                        <li>
                            <a href="video.jsp">Lyics Video</a>
                        </li>
                        <li>
                            <a href="video.jsp">Collaboration Video</a>
                        </li>
                    </ul>
                </div>
                <div class="footer_nav">
                    ...
                    <ul class="footer_content">
                        <li>
                            <a href="artist.jsp">Female</a>
                        </li>
                        <li>
                            <a href="artist.jsp">Male</a>
                        </li>
                    </ul>
                </div>
            </nav>
